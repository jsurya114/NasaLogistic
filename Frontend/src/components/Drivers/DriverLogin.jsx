          ...
          <form onSubmit={handleSubmit}>
            <div className="text-left mb-4">
              ...
              <input
                ...
                className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 
                  ${fieldErrors.email ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-purple-600"}`}
              />
              {fieldErrors.email && (
            ...
            <div className="text-left mb-4">
              ...
              <input
                ...
                className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 
                  ${fieldErrors.password ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-purple-600"}`}
              />
